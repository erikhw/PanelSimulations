...
sim_wfe2 <- function (N = 100, Time = 20, lag.one = 4, lag.two = 6,
                      ...
                      rho_x = .4, rho_x2 = 0.5, lagTreOutc = .2, 
                      beta = 1, beta_x = .2, beta_x2 = 0.5, 
...
### hetereo_ovb ###
cat("Now we are doing New_N50_ephi0.5_T10_hetereo_ovb \n")

# rho_t_1 = .8; rho_1 = .8
reps <- 2000

### hetereo_ovb ###
cat("Now we are doing New_N50_ephi0.5_T20_hetereo_ovb \n")
New_N50_ephi0.5_T20_hetereo_ovb <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 50, T = 20, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N50_ephi0.5_T20_hetereo_ovb, file = "New_N50_ephi0.5_T20_hetereo_ovb")

cat("Now we are doing New_N100_ephi0.5_T20_hetereo_ovb \n")
New_N100_ephi0.5_T20_hetereo_ovb <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 100, T = 20, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N100_ephi0.5_T20_hetereo_ovb, file = "New_N100_ephi0.5_T20_hetereo_ovb")

cat("Now we are doing New_N200_ephi0.5_T20_hetereo_ovb \n")
New_N200_ephi0.5_T20_hetereo_ovb <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 200, T = 20, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N200_ephi0.5_T20_hetereo_ovb, file = "New_N200_ephi0.5_T20_hetereo_ovb")


cat("Now we are doing New_N300_ephi0.5_T20_hetereo_ovb \n")
New_N300_ephi0.5_T20_hetereo_ovb <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 300, T = 20, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N300_ephi0.5_T20_hetereo_ovb, file = "New_N300_ephi0.5_T20_hetereo_ovb")
# 
# 
# ### hetereo ###
