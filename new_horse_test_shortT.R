...
sim_wfe2 <- function (N = 100, Time = 20, lag.one = 1, lag.two = 2,
                      lead = 0,
...
### L = 2 ###
  ...
  Synth_wfe_lag.two_se  <- tryCatch(sd(Synth_wfe_lag.two$boots, na.rm = T), error = function(err) NA)
  Synth_wfe_lag.two_coef  <- tryCatch(Synth_wfe_lag.two$o.coef, error = function(err) NA)
  
  Maha_wfe_lag.two_se  <- tryCatch(sd(Maha_wfe_lag.two$boots, na.rm = T), error = function(err) NA)
  Maha_wfe_lag.two_coef  <- tryCatch(Maha_wfe_lag.two$o.coef, error = function(err) NA)
  
  Pscore_wfe_lag.two_se  <- tryCatch(sd(Pscore_wfe_lag.two$boots, na.rm = T), error = function(err) NA)
...
### hetereo ###
cat("Now we are doing New_N50_ephi0.5_T5_hetereo \n")

New_N50_ephi0.5_T5_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 50, Time = 5, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N50_ephi0.5_T5_hetereo, file = "New_N50_ephi0.5_T5_hetereo")


cat("Now we are doing New_N100_ephi0.5_T5_hetereo \n")
New_N100_ephi0.5_T5_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 100, Time = 5, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N100_ephi0.5_T5_hetereo, file = "New_N100_ephi0.5_T5_hetereo")

cat("Now we are doing New_N200_ephi0.5_T5_hetereo \n")
New_N200_ephi0.5_T5_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 200, Time = 5, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N200_ephi0.5_T5_hetereo, file = "New_N200_ephi0.5_T5_hetereo")


cat("Now we are doing New_N500_ephi0.5_T5_hetereo \n")
New_N500_ephi0.5_T5_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 500, Time = 5, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
save(New_N500_ephi0.5_T5_hetereo, file = "New_N500_ephi0.5_T5_hetereo")
...
New_N50_ephi0.5_T10_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 50, Time = 10, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
...
New_N100_ephi0.5_T10_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 100, Time = 10, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
...
New_N200_ephi0.5_T10_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 200, Time = 10, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
...
New_N500_ephi0.5_T10_hetereo <- pforeach(i = 1:reps,.cores = 19, .seed = 2017)({
  out <- sim_wfe2(N = 500, Time = 10, ephi = 0.5, rho_tt_1 = 0, lagTreOutc = 0, hetereo = T)
  list(out)
})
